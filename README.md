...
pytest -q                        # ~2,275 collected, ~2,237 passed, ~38 skipped on a minimal env (exact counts vary)
...
Generated: 2026-09-17T09:52:41.940554  Horizon scenarios: 5  Passed: 4  Failed: 1
...
CONTINUUM is one library (`src/continuum`, 125 modules) plus a large test suite (162 test files, ~2,275 tests). All modules append to and replay one hash chained event log:
